...
(1, 'Върха на изискаността - Париж', 'Изживейте магията на Париж с посещения на Айфеловата кула, Лувъра и круизи по река Сена.', 'uploads/paris.jpg', 1500.00, 'Франция'),
(2, 'Приключение в Бали', 'Тропически рай с невероятни плажове, културни храмове и водни приключения.', 'uploads/bali.jpg', 1800.00, 'Индонезия'),
(3, 'Ню Йорк - градът, който никога не спи!', 'Изследвайте улиците на Ню Йорк със спиращи дъха забележителности като Таймс Скуеър и Статуята на Свободата.', 'uploads/nyc.jpg', 1200.00, 'САЩ'),
(4, 'Токио и културата на Японкия дух', 'Потопете се в културата на Токио с уроци за приготвяне на суши, посещения на храмове и динамичното Шибуя.', 'uploads/tokyo.jpg', 2000.00, 'Япония'),
(5, 'Неапол - кулинарната столица на Италия и Апенините', 'Изживей необятните вкусове и оживени живот на Неапол от най-тесните улици до най-кътните ресторанти.', 'uploads/naples.jpg', 2500.00, 'Италия'),
(6, 'Рим - Вечният град', 'Изживейте историята на Рим с посещения на Колизеума, Римския форум и Ватикана.', 'uploads/rome.jpg', 1350.00, 'Рим, Италия'),
(7, 'Йоханесбург - приключение в Южна Африка', 'Потопете се в дивата природа на Южна Африка с сафари в националните паркове и наблюдение на диви животни.', 'uploads/johannesburg.jpg', 2200.00, 'Южна Африка'),
...
(9, 'Кейп Таун - крайбрежни приключения и природа', 'Насладете се на спиращите дъха гледки към Столовата планина и плажовете на Кейп Таун.', 'uploads/capetown.jpg', 1800.00, 'Южна Африка'),
(10, 'Мачу Пикчу - Загадката на инките', 'Изкачете се до древния Мачу Пикчу и открийте мистиката на древната инкска цивилизация.', 'uploads/machu.jpg', 2100.00, 'Перу'),
(11, 'Петра - скритото чудо на Йордания', 'Разгледайте древния град Петра, изсечен в скалите, и се потопете в историята на Йордания.', 'uploads/petra.jpg', 1900.00, 'Йордания');
